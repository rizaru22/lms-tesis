...
// use App\Models\ManajemenKuliah\Mapel;
use App\Models\User;
    ...
    public function index()
    {
        ...
        */
        $data = DB::table('ortus')
            ...
            ->select('ortus.*', 'users.foto as foto')
            ->orderBy('ortus.nama', 'asc')
            ->orderBy('ortus.nik', 'asc')
            ->orderBy('ortus.alamat', 'asc')
            ->orderBy('ortus.nohp', 'asc')
            ->orderBy('ortus.email', 'asc')
            ->get();
