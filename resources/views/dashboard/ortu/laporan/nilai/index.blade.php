...
@section('title', 'Laporan Nilai Tugas & Ujian Siswa')
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData(id) {
                $.ajax({
                    type: "GET",
                    url: "{{ route('manajemen.pelajaran.laporan.guru.fetch.data.nilai') }}",
                    data: {
                        key_id: id
                    },
                    dataType: "json",
            ...
            function loadTableData(id)
            {
                let table = $("#tableLaporanNilai").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('manajemen.pelajaran.laporan.guru.fetch.table.nilai') }}",
                        type: "GET",
                        data: {
                            key_id: id
                        }
