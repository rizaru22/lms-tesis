    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData(id) {
                $.ajax({
                    type: "GET",
                    url: "{{ route('manajemen.pelajaran.laporan.guru.fetch.data.nilai.ujian') }}",
                    data: {
                        key_id: id
                    },
                    dataType: "json",
            ...
            function loadTableData(id) {
                let table = $("#tableLaporanUjian").DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('manajemen.pelajaran.laporan.guru.fetch.table.nilai.ujian') }}",
                        type: "GET",
                        data: {
                            key_id: id
                        }
