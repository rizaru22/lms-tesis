...
@section('title', 'Laporan Nilai Tugas')
    ...
    <div class="container-fluid">
        <div class="row">
            @if ($jadwals->isNotEmpty())
                        ...
                        <div class="card-body p-2">
                            <div class="nav flex-column nav-pills" id="daftarKelas">
                                @foreach ($jadwals as $jadwal)
                                    @php
                                        $key = $jadwal->kelas_id . '_' . $jadwal->mapel_id . '_' . $jadwal->guru_id;
                ...
                <div id="dataNilaiTugas" class="col-lg-9 col-12"></div>
            @else
                <div class="col-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadData(id) {
                $.ajax({
                    type: "GET",
                    url: "{{ route('manajemen.pelajaran.laporan.guru.fetch.data.nilai.tugas') }}",
                    data: {
                        key_id: id
                    },
                    dataType: "json",
            ...
            function loadTableData(id) {
                let table = $("#tableLaporanTugas").DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                        url: "{{ route('manajemen.pelajaran.laporan.guru.fetch.table.nilai.tugas') }}",
                        type: "GET",
                        data: {
                            key_id: id
                        }
